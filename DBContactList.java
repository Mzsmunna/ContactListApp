...
public class DBContactList extends JPanel implements MouseListener
{
	//int mouseHoverRow = -1;
  JTable jt;
  ...
  JFrame mF;
  JPanel cP;
  DBContactList(JFrame mainFrame, JPanel contactPanel)
  {
    mF=mainFrame;
    cP=contactPanel;
    ...
    ResultSet rs=stmt.executeQuery("select Contact_Name from contactlist order by Contact_Name ASC");
